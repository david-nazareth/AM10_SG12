...
ggplot(taxi_out_time_apt, aes(x=fct_reorder(airport_w_code, percentage_change, .desc = TRUE), y=percentage_change))+
  ...
  coord_flip()+
  labs(
    title="Top 10 airports that saw the largest decrease in additional taxi-out time",
    subtitle= "Percentage change in mean additional taxi-out time between 2020 and 2019 (March to September) \n",
    caption= "Source: Eurocontrol Network"
  ) + 
  theme_minimal()+
  theme(
