...
vis1 <- airports %>%
  ...
  theme(plot.margin = unit(c(0, 0, 0, 0), "cm"), strip.text.x = element_text(size = 12, face = "bold", vjust =1), title =element_text(size=16, face='bold', vjust =1, ), plot.subtitle =element_text(size=14, vjust =1), axis.text.x = element_text(color="black", size=13, face="plain"),
    axis.text.y= element_text(color="black", size=13, face="plain"), panel.spacing = unit(2, "lines") )
vis1
...
vis2 <- route_test %>%
  ...
  scale_fill_manual(values = c("#000088", "#2c7fb8"), name="", label= c("Sao Paulo - London", "London - Sao Paulo")) +
  geom_hline(yintercept=0, color="orange") +
...
vis3 <- route_test3 %>%
  ggplot() +
  geom_col(aes(x=(year), y=as.numeric(value), width = 0.5, fill=(route)), position = position_dodge()) +
  scale_fill_manual(values = c("#000088", "#2c7fb8"), name="", label= c("Frankfurt - London", "London - Frankfurt")) +
  geom_hline(yintercept=0, color="orange") +
  coord_cartesian (ylim = c(-1, 0.5)) +
  theme_minimal() +
  labs( x= "", y="") +
...
vis4 <- route_test4 %>%
  ggplot() +
  geom_col(aes(x=(year), y=as.numeric(value), width = 0.5, fill=(route)), position = position_dodge()) +
  scale_fill_manual(values = c("#000088", "#2c7fb8"), name="", label= c("New York - London", "London - New York")) +
  geom_hline(yintercept=0, color="orange") +
  coord_cartesian (ylim = c(-1, 0.5)) +
  theme_minimal() +
  labs( x= "", y="") +
...
vis5 <- route_test5 %>%
  ggplot() +
  geom_col(aes(x=(year), y=as.numeric(value), width = 0.5, fill=(route)), position = position_dodge()) +
  scale_fill_manual(values = c("#000088", "#2c7fb8"), name="", label= c("Dehli - London", "London - Dehli")) +
  geom_hline(yintercept=0, color="orange") +
  coord_cartesian (ylim = c(-1, 0.5)) +
  theme_minimal() +
  labs( x= "", y="") +
...
vis6 <- route_test6 %>%
  ggplot() +
  geom_col(aes(x=(year), y=as.numeric(value), width = 0.5, fill=(route)), position = position_dodge()) +
  scale_fill_manual(values = c("#000088", "#2c7fb8"), name="", label= c("Cape Town - London", "London - Cape Town")) +
  geom_hline(yintercept=0, color="orange") +
  coord_cartesian (ylim = c(-1, 0.5)) +
  theme_minimal() +
  labs( x= "", y="") +
