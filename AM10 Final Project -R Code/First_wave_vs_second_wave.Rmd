...
ggplot(data = combined_data_2nd_wave)+
  geom_line(aes(x = month, 
                y = monthly_volume*3.5, #rescale
                group = country, 
                color = "blue"),
            size=0.8) +
  geom_line(aes(x = month, 
                y = confirmed_cases_per_1000*105, #rescale for better visualisation
                group = country,
                color = "red"),
            size=0.8) +
  geom_rect(aes(xmin=3,xmax=4,ymin=-Inf, ymax=Inf),
    ...
    geom_rect(aes(xmin=9,xmax=10,ymin=-Inf, ymax=Inf),
            ...
            alpha=0.03)+
  facet_wrap(~country)+
  theme(scale_y_continuous(label = comma, 
                           sec.axis = sec_axis(~./5, name = "Flights")))+
  labs(title = "Trend contrast")+
  theme_bw()+
  ylab("")+
  scale_colour_discrete(labels=c("number_of_flights","confirmed_cases per 1000"))+
...
ggplot(data = combined_data_india)+
  geom_line(aes(x = month, 
                y = monthly_volume*3.5, #rescale for better visualisation
                group = 1,
                color = "blue"),
            size=0.8) +
  geom_line(aes(x = month, 
  ...
  theme_bw()+
  ylab("")+
  scale_colour_discrete(labels=c("number_of_flights","confirmed cases per 1000"))+
  theme(axis.title.x = element_blank(),
        axis.ticks.y = element_blank(),
        legend.title = element_blank(),
        axis.text.y = element_blank(),
